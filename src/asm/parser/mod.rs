    ...
    S: std::borrow::Borrow<str>,
{
    ...
    let chars = fileserver.get_str(report, span, file_handle)?;
...
pub fn parse(report: &mut diagn::Report, tokens: &[syntax::Token]) -> Result<AstTopLevel, ()>
{
...
) -> Result<AstTopLevel, ()>
{
    ...
    while !walker.is_over() && !walker.next_is(0, syntax::TokenKind::BraceClose)
    {
