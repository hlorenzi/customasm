...
impl Report {
    ...
    fn print_msg_src(
        ...
        let chars = fileserver
            .get_chars(RcReport::new(), &spans[0].file, None)
            .ok()
            .unwrap();
        let counter = CharCounter::new(&chars);
...
impl RcReport {
    pub fn new() -> RcReport {
        RcReport {
            report: Rc::new(RefCell::new(Report::new())),
        }
    }
    ...
    pub fn transfer_to(&self, other: RcReport) {
        self.report
            .borrow_mut()
            .transfer(&mut other.report.borrow_mut());
    }
    ...
    pub fn has_message_at(
        ...
        self.report
            .borrow_mut()
            .has_message_at(fileserver, filename, kind, line, error_excerpt)
    }
    ...
    pub fn has_error_at(
        ...
        self.report
            .borrow_mut()
            .has_error_at(fileserver, filename, line, error_excerpt)
    }
    ...
    pub fn has_first_error_at(
        ...
        self.report
            .borrow_mut()
            .has_first_error_at(fileserver, filename, line, error_excerpt)
    }
