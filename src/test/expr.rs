...
fn test_literals()
{
	...
	test("8'5",   Pass(expr::Value::make_integer(util::BigInt::new(0x8, None))));
	test("8'0x0", Pass(expr::Value::make_integer(util::BigInt::new(0x8, None))));
	test("8 xxx", Pass(expr::Value::make_integer(util::BigInt::new(0x8, None))));
}
